...
COPY target/ranger-2.2.0-SNAPSHOT-admin.tar.gz /ranger-2.2.0-SNAPSHOT-admin.tar.gz
COPY target/ranger-2.2.0-SNAPSHOT-atlas-plugin.tar.gz /ranger-2.2.0-SNAPSHOT-atlas-plugin.tar.gz
RUN tar -xzf /ranger-2.2.0-SNAPSHOT-admin.tar.gz -C /opt/apache/ranger-admin --strip-components=1
